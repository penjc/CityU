...
<div align="center" style={{ lineHeight: '1.5', fontSize: '0.9rem' }}>
    ...
    <p style={{ marginBottom: '0.5rem', color: '#555' }}>感谢您访问 <strong>CityU 手册</strong>！我们很高兴您对本项目感兴趣，并期待您的参与。本指南将帮助您快速上手并有效地做出贡献。</p>
</div>
...
- **模版链接**：[课程页面模版](https://github.com/penjc/CityU/COURSE_TEMPLATE)
