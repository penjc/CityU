...
<div align="center" style={{ lineHeight: '1.5', fontSize: '0.9rem' }}>
    <h1 style={{ marginBottom: '0.5rem', fontSize: '2.5rem', background: 'linear-gradient(90deg, #de6f31, #da542b, #bf1846, #9f0c43)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}><strong>CityU 课程指南</strong></h1>
