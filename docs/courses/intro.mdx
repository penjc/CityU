...
<div align="center" style={{ lineHeight: '1.5', fontSize: '0.9rem' }}>
    ...
    <small style={{ fontSize: '0.6rem', color: '#777' }}>
        ...
        目前，课程指南已完整收录 <a href="https://penjc.github.io/cityU-navigator/docs/category/college-of-computing" style={{ color: '#bf1846', textDecoration: 'none' }}>计算机院</a> 等院系的课程内容和评价，供您参考和使用。<br />
...
- [📘 City U Academy Of Innovation](https://penjc.github.io/cityU-navigator/docs/category/cityu-academy-of-innovation)
...
📘 **当前进展**  
目前，课程指南已完整收录 [计算机院](https://penjc.github.io/cityU-navigator/docs/category/college-of-computing) 等院系的课程内容和评价，供您参考和使用。
